...
Índice dos materiais do projeto (código permanece na raiz: `pepmem/`, `scripts/`, `api/`, `dashboard/`, `data/`).
...
| [fontes/](fontes/) | Links de download de bases públicas (OPM) |

Scripts de staging Hugging Face: ver `deploy/README_HF.md` na raiz do repositório (usado por `scripts/deploy_hf_space.py`).
