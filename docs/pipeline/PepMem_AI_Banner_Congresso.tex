...
\begin{center}
\metriccard{Baseline RF}{0,88}{PmGreen}\hspace{0.2cm}%
\metriccard{Multimodal}{0,81}{PmVenomDeep}
\end{center}
\vspace{0.15em}
\begin{center}
...
\end{center}
{\scriptsize Acc.\ LOPO baseline 0,74. Matriz: limiar 0,5 na prob.\ calibrada.}
}
...
\begin{enumerate}
  ...
  \item Baseline LOPO AUC $\approx$\textbf{0,88}; multimodal $\approx$\textbf{0,81}
